...
describe :kernel_protected_methods_with_invalid_argument, shared: true do
  it "raises an ArgumentError" do
    -> {ReflectSpecs::F.protected_methods(@object)}.should raise_error ArgumentError
    -> {ReflectSpecs::F.new.protected_methods(@object)}.should raise_error ArgumentError
  end
end
...
describe "Kernel#protected_methods" do
  ...
  ruby_version_is "3.1" do
    describe "when passed nil" do
      it_behaves_like :kernel_protected_methods_with_invalid_argument, nil, nil
    end

    describe "when passed an integer" do
      it_behaves_like :kernel_protected_methods_with_invalid_argument, nil, 1
    end
  end
end
