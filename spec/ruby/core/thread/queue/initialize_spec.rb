...
describe "Thread::Queue#initialize" do
  ...
  ruby_version_is '3.1' do
    ...
    it "raises if the provided Enumerable does not respond to #to_a" do
      enumerable = MockObject.new('mock-enumerable')
      -> { Thread::Queue.new(enumerable) }.should raise_error(TypeError, "can't convert MockObject into Array")
    end
  end
end
