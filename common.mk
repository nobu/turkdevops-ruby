...
cont.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
...
eval.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
...
fiber_scheduler.$(OBJEXT): $(CCAN_DIR)/check_type/check_type.h
fiber_scheduler.$(OBJEXT): $(CCAN_DIR)/container_of/container_of.h
fiber_scheduler.$(OBJEXT): $(CCAN_DIR)/list/list.h
fiber_scheduler.$(OBJEXT): $(CCAN_DIR)/str/str.h
fiber_scheduler.$(OBJEXT): $(hdrdir)/ruby/ruby.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/array.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/compilers.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/gc.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/imemo.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/serial.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/static_assert.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/vm.h
fiber_scheduler.$(OBJEXT): $(top_srcdir)/internal/warnings.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}assert.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/assume.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/attributes.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/bool.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/gcc_version_since.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/inttypes.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/limits.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/long_long.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/stdalign.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}backward/2/stdarg.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}config.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}defines.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}encoding.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}id.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}intern.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/anyargs.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/char.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/double.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/fixnum.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/gid_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/int.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/intptr_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/long.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/long_long.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/mode_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/off_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/pid_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/short.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/size_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/st_data_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/arithmetic/uid_t.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/assume.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/alloc_size.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/artificial.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/cold.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/const.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/constexpr.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/deprecated.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/diagnose_if.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/enum_extensibility.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/error.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/flag_enum.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/forceinline.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/format.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/maybe_unused.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/noalias.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/nodiscard.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/noexcept.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/noinline.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/nonnull.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/noreturn.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/pure.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/restrict.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/returns_nonnull.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/warning.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/attr/weakref.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/cast.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/config.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/constant_p.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rarray.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rbasic.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rbignum.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rclass.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rdata.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rfile.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rhash.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/robject.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rregexp.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rstring.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rstruct.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/core/rtypeddata.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/ctype.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/dllexport.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/dosish.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/error.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/eval.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/event.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/fl_type.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/gc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/glob.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/globals.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/attribute.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/builtin.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/c_attribute.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/cpp_attribute.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/declspec_attribute.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/extension.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/feature.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/has/warning.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/array.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/bignum.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/class.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/compar.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/complex.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/cont.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/dir.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/enum.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/enumerator.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/error.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/eval.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/file.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/gc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/hash.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/io.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/load.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/marshal.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/numeric.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/object.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/parse.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/proc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/process.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/random.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/range.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/rational.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/re.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/ruby.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/select.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/select/largesize.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/signal.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/sprintf.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/string.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/struct.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/thread.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/time.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/variable.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/intern/vm.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/interpreter.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/iterator.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/memory.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/method.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/module.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/newobj.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/rgengc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/scan_args.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/fiber_scheduler.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/special_consts.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/static_assert.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/stdalign.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/stdbool.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/symbol.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/token_paste.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/value.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/value_type.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/variable.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/warning_push.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}internal/xmalloc.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}io.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}method.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}missing.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}node.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}onigmo.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}oniguruma.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}ruby_assert.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}ruby_atomic.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}fiber_scheduler.c
fiber_scheduler.$(OBJEXT): {$(VPATH)}st.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}subst.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}thread_$(THREAD_MODEL).h
fiber_scheduler.$(OBJEXT): {$(VPATH)}thread_native.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}vm_core.h
fiber_scheduler.$(OBJEXT): {$(VPATH)}vm_opts.h
...
io.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
...
process.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
...
thread.$(OBJEXT): $(top_srcdir)/internal/fiber_scheduler.h
