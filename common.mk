...
ACTIONS_TTY = $(GITHUB_ACTIONS:true=--tty=no)
...
yes-btest: yes-fake miniruby$(EXEEXT) PHONY
	$(ACTIONS_GROUP)
	$(Q)$(gnumake_recursive)$(exec) $(BOOTSTRAPRUBY) "$(srcdir)/bootstraptest/runner.rb" --ruby="$(BTESTRUBY) $(RUN_OPTS)" \
	    $(ACTIONS_TTY) $(OPTS) $(TESTOPTS) $(BTESTS)
	$(ACTIONS_ENDGROUP)
...
yes-btest-ruby: prog PHONY
	$(ACTIONS_GROUP)
	$(Q)$(gnumake_recursive)$(exec) $(RUNRUBY) "$(srcdir)/bootstraptest/runner.rb" --ruby="$(PROGRAM) -I$(srcdir)/lib $(RUN_OPTS)" \
	    $(ACTIONS_TTY) $(OPTS) $(TESTOPTS) $(BTESTS)
	$(ACTIONS_ENDGROUP)
...
btest-bruby: prog PHONY
	$(ACTIONS_GROUP)
	$(Q)$(gnumake_recursive)$(exec) $(BOOTSTRAPRUBY) "$(srcdir)/bootstraptest/runner.rb" --ruby="$(PROGRAM) -I$(srcdir)/lib $(RUN_OPTS)" \
	    $(ACTIONS_TTY) $(OPTS) $(TESTOPTS) $(BTESTS)
	$(ACTIONS_ENDGROUP)

rtest: yes-fake miniruby$(EXEEXT) PHONY
	$(ACTIONS_GROUP)
	$(Q)$(exec) $(BOOTSTRAPRUBY) "$(srcdir)/bootstraptest/runner.rb" --ruby="$(BTESTRUBY) $(RUN_OPTS)" --sets=ractor -v $(ACTIONS_TTY)
	$(ACTIONS_ENDGROUP)
