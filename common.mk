...
abi.$(OBJEXT): $(top_srcdir)/internal/abi.h
abi.$(OBJEXT): {$(VPATH)}abi.c
abi.$(OBJEXT): {$(VPATH)}config.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/apple.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/clang.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/gcc.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/intel.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/msvc.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_is/sunpro.h
abi.$(OBJEXT): {$(VPATH)}internal/compiler_since.h
abi.$(OBJEXT): {$(VPATH)}internal/config.h
...
dln.$(OBJEXT): $(top_srcdir)/internal/abi.h
